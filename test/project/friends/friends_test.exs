defmodule Project.FriendsTest do
  ...
  describe "friends" do
    ...
    @valid_attrs %{friend_id: 42, user_id: 42}
    @update_attrs %{friend_id: 43, user_id: 43}
    @invalid_attrs %{friend_id: nil, user_id: nil}
    ...
    test "create_friend/1 with valid data creates a friend" do
      ...
      assert friend.friend_id == 42
      assert friend.user_id == 42
    end
    ...
    test "update_friend/2 with valid data updates the friend" do
      ...
      assert friend.friend_id == 43
      assert friend.user_id == 43
    end
