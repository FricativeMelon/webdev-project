defmodule Project.CalendarsTest do
  use Project.DataCase

  alias Project.Calendars

  describe "calendars" do
    alias Project.Calendars.Calendar

    @valid_attrs %{timestamp: ~D[2010-04-17]}
    @update_attrs %{timestamp: ~D[2011-05-18]}
    ...
    test "create_calendar/1 with valid data creates a calendar" do
      ...
      assert calendar.timestamp == ~D[2010-04-17]
    end
    ...
    test "update_calendar/2 with valid data updates the calendar" do
      ...
      assert calendar.timestamp == ~D[2011-05-18]
    end
